...
static struct lkg_maxvolt lkg_volt_table[] = {
	{.leakage_level = 9000,		.maxvolt = CONFIG_RK3188_LEAKAGE_9000 * 1000},
	{.leakage_level = 15000,	.maxvolt = CONFIG_RK3188_LEAKAGE_15000 * 1000},
	{.leakage_level = 55000,	.maxvolt = CONFIG_RK3188_LEAKAGE_55000 * 1000},
};
/*leolas default was
static struct lkg_maxvolt lkg_volt_table[] = {
...
static struct cpufreq_frequency_table logic_high_arm_table[] = {
        ...
        {.frequency = 1608 * DVFS_KHZ, .index = 100 * DVFS_MV},
        {.frequency = CPUFREQ_TABLE_END}, //leolas
};
#endif
