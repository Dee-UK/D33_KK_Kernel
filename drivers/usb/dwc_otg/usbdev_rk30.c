...
void usb20otg_hw_init(void)
{
        ...
        *otg_phy_con3 = (0x0300 << 16);
        ...
        gpio_direction_output(RK3066B_OTG_DRV_VBUS, GPIO_HIGH);//gpio_direction_output(RK3066B_OTG_DRV_VBUS, GPIO_LOW);
#else
...
{ 
    ...
    if(0 == enable)//disable
    {
         gpio_set_value(RK3066B_OTG_DRV_VBUS, GPIO_HIGH); //gpio_set_value(RK3066B_OTG_DRV_VBUS, GPIO_LOW); 
