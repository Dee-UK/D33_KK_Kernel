...
#ARCH		?= $(SUBARCH)
ARCH		?= arm
ifneq ($(wildcard ../android/toolchain/arm-eabi-4.4.3),)
CROSS_COMPILE	?= ../android/toolchain/arm-eabi-4.4.3/bin/arm-eabi-
endif
...
ifneq ($(wildcard ../android/prebuilts/gcc/linux-x86/arm/arm-eabi-4.6),)
