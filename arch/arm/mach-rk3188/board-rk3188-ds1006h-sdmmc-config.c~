...
*/          
	...
	#define RK30SDK_WIFI_GPIO_POWER_N               RK30_PIN3_PB4
	#define RK30SDK_WIFI_GPIO_POWER_ENABLE_VALUE    GPIO_HIGH
	#define RK30SDK_WIFI_GPIO_POWER_PIN_NAME        "GPIO_WIFI_POWER"
	#define RK30SDK_WIFI_GPIO_POWER_IOMUX_FGPIO     GPIO3_D2 

	#define RK30SDK_WIFI_GPIO_RESET_N               RK30_PIN3_PC6
	#define RK30SDK_WIFI_GPIO_RESET_ENABLE_VALUE    GPIO_HIGH 
	#define RK30SDK_WIFI_GPIO_RESET_PIN_NAME        "GPIO_WIFI_RESET"
	#define RK30SDK_WIFI_GPIO_RESET_IOMUX_FGPIO     GPIO3_C6 
